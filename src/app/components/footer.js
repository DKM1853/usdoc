    ...
    <footer className="bg-[#004AAB] text-white px-8 py-12 text-center">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-4 space-y-4">
            ...
            <div className="flex justify-center ">
              <Link
                href="https://www.instagram.com/usdocnetwork?igsh=aDR6OHU4NWYzOHo4"
              ...
              <Link
                href="https://www.facebook.com/share/1BVXmCzE7X/"
                className="hover:text-gray-300"
              >
                <svg
                  width="96"
              ...
              <Link
                href="https://x.com/usdocglobal?s=08"
                className="hover:text-gray-300"
              >
                <svg
                  width="96"
        ...
        <div className="mt-12 pt-8 border-t border-gray-600 text-center">
          <p className="text-sm text-gray-300">
            Copyright © US DOC 2025 All rights reserved
          </p>
        </div>
      </div>
    </footer>
