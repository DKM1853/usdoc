...
export default function Footer() {
  ...
  const navLinks = [
    { name: "Home", url: "/" },
    { name: "Excellence Program", url: "/Excellence-Program" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-4 space-y-4">
            ...
            <div className="flex justify-center ">
              ...
              <Link href="https://www.facebook.com/share/1A31fSgfCe/?mibextid=qi2Omg" className="hover:text-gray-300">
                <svg
                  width="96"
                  height="97"
                  viewBox="0 0 96 97"
