      ...
      <div className="relative flex flex-col items-center gap-12">
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 w-full md:w-3/4">
          <div className="p-6 rounded-lg border border-[#004AAB] shadow-lg w-full md:w-1/2">
            ...
            >
              Our expert consultants will evaluate your qualifications, career
              aspirations, and personal preferences to offer tailored advice and
              guidance, helping you make informed decisions for your medical
              career in Germany.
            </p>
          </div>
        ...
        <div className="flex justify-end w-full md:w-3/4 -mt-[2%] second-container-set">
          <div className="p-6 border border-[#004AAB] rounded-lg shadow-lg w-full md:w-1/2">
            ...
            >
              We provide comprehensive assistance in preparing and submitting
              your application documents, ensuring they meet the rigorous
              standards and requirements set by German authorities.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-start w-full md:w-3/4 mt-[1%]">
          <div className="p-6 border border-[#004AAB] rounded-lg shadow-lg w-full md:w-1/2">
            ...
            >
              Our dedicated team will help you prepare for interviews, ensuring
              you are confident and fully ready to succeed in securing your
              position in Germany&apos;s healthcare system.{" "}
            </p>
          </div>
        </div>
      </div>
